...
def plot_prob(time_idx):
    ...
    yEACr.append(count_EAC/12121)
    yTSWr.append(count_TSW/12121)
...
# set range
start = 0
end = 276 # for 277 files (zero index)
...
output_fn = '../outputs/classification_stack/' + 'index-stack_' + str(start).zfill(3) + '-' + str(end).zfill(3) + '.csv' 
