# 3d scatter plot of machine learning TS profiles
...
for i in range(start, end):
    ...
    for j in range(0, 1):
        ...
        # attach data
        temp_ls.extend(list(temp))
        salt_ls.extend(list(salt))
        prob_ls.extend(list(prob))
        time_ls.extend([frame_time]*len(temp))
