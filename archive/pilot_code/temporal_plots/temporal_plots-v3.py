...
# report line_kws
slope, intercept, r_value, p_value, std_err = stats.linregress(range(0,len(data3['yEACr'])),data3['yEACr'])
print('YEARLY MEANS')
...
# extra thing to get base values for paper I put in later (get the shit I want)
print('from:')
print(data4a.yEACr.mean())
print('to:')
print(data4b.yEACr.mean())
print('\ndiff:')
print(data4b.yEACr.mean() - data4a.yEACr.mean())
