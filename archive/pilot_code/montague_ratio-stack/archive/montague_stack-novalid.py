...
start = 0
end = 50 # for 277 files (zero index but range() does not include last number)
...
output_fn = '../montague_ratio-stack/output/' + 'TEST_mont-stack_' + str(start).zfill(3) + '-' + str(end).zfill(3) + '_' + dt + '.csv' 
