...
count_Jarv = analyse_region_counts(ROMS_directory, lr_model, JarvBox, depthmax=4000)
...
# save data
count_Jarv.to_csv('./data/count_Jarv.csv', index=False)
